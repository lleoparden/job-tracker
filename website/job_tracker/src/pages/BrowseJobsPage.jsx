  ...
  return (
    <div className="flex flex-col items-center text-center bg-white min-h-screen py-20">
      <div className="w-24 h-24 bg-[#20aae4]/10 rounded-3xl flex items-center justify-center mb-6">
        <Search className="w-12 h-12 text-[#20aae4]" />
      </div>
      <h2 className="text-3xl font-bold mb-2 text-gray-900">Browse Jobs</h2>
      <p className="text-gray-600 mb-8">Coming soon! Browse all your saved jobs here.</p>
